...
export const houseWords: HouseWords[] = [
  ...
  { house: 'House Umber', words: 'Death Before Chains', note: 'Last Hearth. Semi-canon: never spoken in the novels or the show, but released by Elio García from Martin’s heraldry notes. The Greatjon lived them either way.' },
  ...
  { house: 'House Fossoway of Cider Hall', words: 'Taste of Glory', note: 'Red apple. The green apple cadets split at Ashford.' },
  ...
  { house: 'House Plumm', words: 'Come Try Me', note: 'The westerlands. Three purple plums on gold.' },
  ...
  { house: 'House Wensington', words: 'Sound the Charge', note: 'The stormlands. Two gold trumpets crossed on blue.' },
  ...
  { house: 'House Wode', words: 'Touch Me Not', note: 'Three white hedgehogs on gold. A small house of the riverlands.' },
