...
export function ThronePage() {
  ...
  useHashScroll('throne', chapterOrFace)
    ...
    <div className="throne">
      ...
      <main id={MAIN_ID} tabIndex={-1}>
        <section className="room-hero">
          <img src={`${asset('throne/got/hero.jpg')}?v=throne`} alt="" className="room-hero-art" {...heroImg()} />
        ...
        {throneChapters.map((chapter, index) => (
          ...
          >
            <figure className="throne-scroll-art">
              <img src={`${asset(chapter.image)}?v=throne`} alt="" {...lazyImg(WIDE)} />
            </figure>
          ...
          <div className="throne-place-grid">
            {thronePieces.map((piece) => (
              <article key={piece.id} id={piece.id} className="throne-place">
                <img src={asset(piece.image)} alt={piece.name} {...lazyImg(WIDE)} />
            ...
            return (
              <div key={bench} className="throne-side">
                ...
                <div className="throne-face-grid">
                  {faces.map((face) => (
                    <article key={face.id} id={faceId(face.id)} className="throne-face">
