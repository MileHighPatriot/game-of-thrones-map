...
import { heroImg, lazyImg, WIDE } from '../lib/img.ts'
    ...
    <div className="words">
      ...
      <main id={MAIN_ID} tabIndex={-1}>
        <section className="words-hero">
          <img src={asset('words/got/weirwood.jpg')} alt="" className="words-hero-art" {...heroImg()} />
        ...
        <section className="words-chapter" id="houses">
          <div className="words-chapter-head">
            <img src={asset('words/parchment.jpg')} alt="" {...lazyImg(WIDE)} />
            <div>
        ...
        <section className="words-chapter" id="voices">
          <div className="words-chapter-head">
            <img src={asset('words/got/ravens.jpg')} alt="" {...lazyImg(WIDE)} />
            <div>
        ...
        <section className="words-chapter words-chapter-oaths" id="oaths">
          <div className="words-chapter-head">
            <img src={asset('words/got/wall.jpg')} alt="" {...lazyImg(WIDE)} />
            <div>
        ...
        <section className="words-chapter" id="prophecies">
          <div className="words-chapter-head">
            <img src={asset('words/got/comet.jpg')} alt="" {...lazyImg(WIDE)} />
            <div>
          ...
          <figure className="words-close">
            <img src={asset('words/got/heart-tree.jpg')} alt="" {...lazyImg(WIDE)} />
            <figcaption>
